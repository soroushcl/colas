export interface RunningToSimulatedParams {
  viewAssessmentLink: string;
}

export const runningToSimulated = (inputs: RunningToSimulatedParams) => {
            ...
            <tr>
              <td align="left" style="padding: 72px 60px; text-align: left">
                ...
                <p
                  ...
                  "
                >
                  Your assessment results are available!
                  <br />
                </p>
                ...
                <p
                  ...
                  "
                >
                  If you need any help in understanding or using these results,
                  reach out to us for the support of our in-house experts.
                  <br /><br />— The Cola's Team
                </p>
                <hr
                  style="
                    border: 0;
