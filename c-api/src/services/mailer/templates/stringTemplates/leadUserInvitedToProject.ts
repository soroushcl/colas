export interface LeadUserInvitedToProjectParams {
  projectName: string;
  viewProjectLink: string;
  companyName: string;
}

export const leadUserInvitedToProject = (
  inputs: LeadUserInvitedToProjectParams,
) => {
  const { projectName, viewProjectLink, companyName } = inputs;
            ...
            <tr>
              <td align="left" style="padding: 72px 60px; text-align: left">
                ...
                <p
                  ...
                  "
                >
                  As a lead, you will be able to manage buildings and
