export interface PendingToUnderReviewParams {
  assessmentName: string;
}

export const pendingToUnderReview = (inputs: PendingToUnderReviewParams) => {
  const { assessmentName } = inputs;
            ...
            <tr>
              <td align="left" style="padding: 72px 60px; text-align: left">
                ...
                <p
                  ...
                  "
                >
                  We’re reviewing your assessment!<br />
                </p>
                ...
                <p
                  ...
                  "
                >
                  You won’t need to take any steps yet. We will send you status
                  emails to keep you updated.<br /><br />— The Cola's Team
                </p>
                <hr
                  style="
                    border: 0;
