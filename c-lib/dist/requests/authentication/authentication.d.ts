...
export type loginResponseBody = Success<{
...
export type googleLoginResponseBody = Success<{
    user: AuthenticatedUser;
    token: string;
}> | Fail;
...
export type googleRegResponseBody = Success<{
    email: string;
}> | Fail;
...
export type registerResponseBody = Success<{
    user: AuthenticatedUser;
}> | Fail;
export interface registerDogRequestBody {
    dog: Dog;
}
export type registerDogResponseBody = Success<{
    dog: Dog;
    recipes: Recipe[];
}> | Fail;
...
export type createSubscriptionResponseBody = Success<{
    subscription: Subscription;
}> | Fail;
...
export type resetPasswordResponseBody = Success<{
    user: AuthenticatedUser;
    token: string;
}> | Fail;
