...
const Home: React.FC = observer(() => {
    ...
    return (
        <ProcessLayout title={`*${dogStore.dog.name}'s* custom meals`} subTitle={`We have adjusted these recipes based on your pup’s needs`} handleSubmit={handleSubmit} disabled={false} nextArrow mainButtonText={"Next"} secondary secondaryButtonText='Click to choose other recipes' registeredDogs={userStore.registeredDogs}>
