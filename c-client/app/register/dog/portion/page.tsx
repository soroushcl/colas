                            ...
                            <div className={`w-full md:max-w-[700px] my-0 mx-auto bg-system_accent md:bg-gray_background md:my-8 py-0 px-0 grow w-full max-h-full relative flex flex-col items-center gap md:rounded-3xl  overflow-hidden`}>
                                <div className='flex flex-col w-full h-full grow'>
                                    <div className='grow flex flex-col'>
                                        <div className='w-full h-[44vh] min-h-[800px] md:h-[38vh] bg-system_dark_primary text-system_accent font-normal text-center pt-24'>
                                        ...
                                        <div className='w-full h-[44vh] md:h-[38vh] min-h-[800px] text-center pt-48 flex flex-col items-center justify-between bg-system_accent md:bg-gray_background'>
