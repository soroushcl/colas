...
const Home: React.FC = observer(() => {
    ...
    return (
        <ProcessLayout title={`*${dogStore.dog.name}'s* Nutrition Analysis`} subTitle={`${dogStore.dog.name}'s ideal recipe would consist of:`} handleSubmit={handleSubmit} disabled={!recipe} nextArrow mainButtonText={"Next"} registeredDogs={userStore.registeredDogs}>
