                ...
                <div className='pt-3 h-full'>
                    <div className='space-y-1 flex flex-col justify-evenly h-full'>
                        <div className='flex flex-row justify-between items-center'>
                            ...
                            <span className={`text-sm text-label_secondary ${isActive ? '' : ''}`}>{recipes}</span>
                        </div>
                        <div className='flex flex-row justify-between items-center'>
                            <span className={`text-sm text-label_tertiary ${isActive ? '' : ''}`}>Meal Plan:</span>
                            <div className='h-px mx-4 border-t border-dotted border-gray_divider grow'></div>
                            <span className={`text-sm text-label_secondary ${isActive ? '' : ''}`}>{plan}</span>
                        </div>
                        <div className='flex flex-row justify-between items-center'>
                            <span className={`text-sm text-label_tertiary ${isActive ? '' : ''}`}>No. of Full/Half Meals:</span>
                            <div className='h-px mx-4 border-t border-dotted border-gray_divider grow'></div>
                            <span className={`text-sm text-label_secondary ${isActive ? '' : ''}`}>{`${meals} Daily Meals`}</span>
                        </div>
                        <div className='flex flex-row justify-between items-center'>
                            ...
                            <div className='flex flex-row justify-between items-center gap-1'>
                                ...
                                <span className={`text-sm font-bold ${isActive ? 'text-system_light_primary' : ' text-label_secondary'}`}>{(totalPrice * (100 - discountRate) / 100).toFixed(2)}{"$"}</span>
                            </div>
                        </div>
                    </div>
                </div>
